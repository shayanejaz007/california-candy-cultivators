    ...
    <>
      ...
      {menuLocked ? (
        <section id="menu" style={{ maxWidth: 1320, margin: '0 auto', padding: '112px 24px 24px' }}>
          ...
          {/*
            Nothing about the catalogue is rendered here — not names, not counts.
            The server sends an empty menu to unapproved visitors, so there is no
            hidden markup to read out of the page source.
          */}
          <div
            style={{
              marginTop: 34,
              padding: 'clamp(32px,6vw,64px)',
              border: '1px solid rgba(234,240,234,.12)',
              borderRadius: 4,
          ...
          >
            ...
            >
              {accountStatus === 'PENDING' ? 'Awaiting approval' : 'Approved accounts only'}
            </div>

            <p
              style={{
                font: '300 clamp(15px,2vw,19px)/1.65 ' + SANS,
            ...
            >
              {accountStatus === 'PENDING'
                ? 'Your account is waiting on manual review. Once it is approved the current menu will appear here.'
                : 'Current strains, availability and pricing are shared with approved accounts. Request access and we will review it, usually within a business day.'}
            </p>

            {accountStatus === 'PENDING' ? null : (
              <div style={{ display: 'flex', gap: 12, justifyContent: 'center', marginTop: 30, flexWrap: 'wrap' }}>
                <Link
                  href="/signup"
                  style={{
                    display: 'inline-flex', alignItems: 'center', minHeight: 54, padding: '0 32px',
                    border: 0, borderRadius: 2, background: C.green, color: '#f4faf5',
                    font: '600 12px/1 ' + SANS, letterSpacing: '.24em', textTransform: 'uppercase'
                  }}
                >
                  Request access
                </Link>
